...
class _Sandbox(ImmutableSandboxedEnvironment):
    ...
    is_safe_callable = lambda self, obj: isinstance(getattr(obj, "__self__", None), dict) and getattr(obj, "__name__", None) in {"get", "items", "keys", "values"}  # noqa: E501,E731  # fmt: skip
