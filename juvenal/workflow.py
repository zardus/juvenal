...
def apply_vars(text: str, vars: dict[str, object] | None) -> str:
...
def _substitute_known_template_vars(text: str, vars: dict[str, object]) -> str:
...
class Phase:
    ...
    def render_prompt(self, failure_context: str = "", vars: dict[str, object] | None = None) -> str:
    ...
    def render_check_prompt(self, vars: dict[str, object] | None = None) -> str:
